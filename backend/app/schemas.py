...
class SupplierSchema(Schema):
    ...
    min_order_amount = fields.String(load_default=None)
    price_range = fields.String(load_default=None)
    has_certificates = fields.Boolean(load_default=False)
...
class SupplierCreateSchema(SupplierSchema):
    """Схема для создания — принимает category_ids."""
    pass
...
class SupplierUpdateSchema(Schema):
    ...
    min_order_amount = fields.String()
    price_range = fields.String()
    has_certificates = fields.Boolean()
