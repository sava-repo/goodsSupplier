...
Стек выбран потому что ранее с ним работал - это важно для vibe-coding проектов, иметь возможность прочитать и исправить код при необходимости. Использование другого стека требует большего времени на погружение (реализуемо, если есть необходимость). Кроме того в вакансии был запрос на Python+SQL, что я и продемонстрировал в проекте. 
